...
# Короткие/двусмысленные ключевые слова (типа "вк", "yt") сравниваются
...
# "ok"/"ок" сюда намеренно не добавлены даже как целое слово — это ходовое
# междометие ("ок, погнали"), а не только сокращение Одноклассников, поэтому
# оно и подстрокой, и отдельным словом слишком легко совпадёт со случайным
# названием (проверено: "trovo ok" ловился бы как Одноклассники, а не Trovo).
